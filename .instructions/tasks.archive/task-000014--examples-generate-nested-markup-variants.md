...
- 2026-01-14
	- Updated Example/generate-examples.ps1 to add nested markup variants:
	...
	- Kept generation streaming + deterministic (no randomness; periodic flush).
	- Updated Example/README.md to document new variants and filename mapping.
	- Validation: ran generator for txt-nested-envelope-basic (1MB) and confirmed output file was created.